...
NSString *const LOGIN_DONE = @"LOGIN_DONE";
NSString *const FILTER_UPDATE = @"FILTER_UPDATE";
...
NSString *const TRANSACTION_TYPE_CARREGAMENTO = @"Carregamento";
